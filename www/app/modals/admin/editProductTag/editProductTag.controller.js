...
angular.module('app.modal.editProductTag', [])        
    .controller('EditProductTagModalCtrl', ['$scope', '$uibModalInstance', '$filter', 'AlertConfirmService', 'editing', 'ApiRoutesGroups', 'roleList',
